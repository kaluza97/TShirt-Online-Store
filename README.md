...
##The application is adapted for mobile devices (Responsive Web Design):
...
##If you want to set up the environment locally, it is necessary to create a project in Firebase and add a .env file (as below)
